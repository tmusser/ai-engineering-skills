...
Each repo solves a different kind of AI-assisted work, but the operating pattern is the same. Start with a clear ask, keep scope bounded, write down assumptions, and leave a durable handoff for the next session.
